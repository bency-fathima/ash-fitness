      ...
      {client ? (
        <div className="flex-1 flex flex-col h-full overflow-hidden">
          ...
          <div className="lg:hidden bg-white px-4 py-3 flex items-center gap-3 border-b">
            ...
            <div className="flex-1">
              <h2 className="text-[#9e5608] font-semibold text-[15px]">
                {client.name}
              </h2>
            ...
            <div className="flex items-center gap-2 lg:gap-3 bg-gray-50 rounded-xl lg:rounded-lg p-2">
              ...
              >
                {isRecording ? (
                  ...
                  <Mic
                    size={20}
                    className="lg:text-gray-400 text-white bg-[#9e5608] rounded-full p-1 w-7 h-7 lg:w-5 lg:h-5 lg:bg-transparent lg:p-0"
                  />
                )}
              </button>
              <button
